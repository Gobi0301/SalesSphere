			...
			<div class="box-list">
				<div class="item">
					<div class="row ">
						...
						<form:form method="POST" id="addForm" action="edit-opportunity"	 modelAttribute="editable">			
							 <input type="hidden" name="opportunityId" path="opportunityId"	value="${editable.opportunityId}" /> 
										...
										<div class="col-sm-12">
											<div class="col-sm-4">
												<div class="form-group">
													...
													<form:select type="text" name="accountId" id="accountId"
														path="accountBO.accountId" class="form-control required">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<form:select type="text" name="assignedTo" path="user.id"
														class="form-control required" id="assignedToInput">
														<c:if test="${opportunityBO.user.id>0}">
													<form:option value="${opportunityBO.user.id}">${opportunityBO.user.name}</form:option>
												</c:if>
														<form:option value="0">Select User</form:option>
										...
										<div class="col-sm-12">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<form:option value="${opportunityBO.productService.serviceId}">${opportunityBO.productService.serviceName}</form:option>
												</c:if>
											...
											<div class="col-sm-4">
												<div class="form-group">
													<label>Expected Closing Date <span
														class="font10 text-danger">*</span></label>
													<form:input type="text" name="endTime" path="endTime"  readonly="true"
														id="datepicker" class="form-control required"  placeholder="Closing Date" maxlength="150" />
												...
												<div class="form-group">
													...
													<form:textarea path="description" id="description"
														class="form-control required" placeholder="Description"
														 maxlength="2000" cols="190" rows="06" />
