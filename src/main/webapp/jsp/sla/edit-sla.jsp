	...
	$(document).ready(function() {
		...
		//Sla Name
			...
			if (Date == '') {
				isValid = false;
				$("#dateErr").show();
				$("#dateErr").html("Please Enter Date Code");
				$("#datepicker").css({
					"border" : "1px solid red",
				});
			} else {
	...
	<div class="box-list">
		<div class="item">
			<div class="row ">
				...
				<form:form method="POST" id="addForm" action="edit-sla"
					modelAttribute="slaBO">
					<div class="col-sm-12">

						<form:hidden path="slaId" name="id" value="${slaBO.slaId}" />
						<div class="col-sm-4">
							<div class="form-group">
								<label> Service Level Agreement (No of Days) <span
									class="font10 text-danger">*</span></label>
								<form:input type="text" id="serviceId" path="slaName"
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<form:input type="text" id="slaCodeId" path="slaCode"
									...
									maxlength="120" onchange="slaCodeCheck()"  />
					...
					<div class="col-sm-4">
							<div class="form-group">
								...
								<form:input type="text" id="descriptionsId" path="descriptions"
									class="form-control required" placeholder="Descriptions"
									maxlength="120" />
