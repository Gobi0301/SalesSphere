	...
	<script>
		$(document).ready(function() {
			$('#btnsubmit').click(function(e) {
				var isValid = true;
				/* var salutation = $('#salutationId').val();
				if (salutation == '') {
					isValid = false;
					$("#salutationErr").show();
					$("#salutationErr").html("Please enter salutation ");
					$("#salutationId").css({
		...
		<div class="box-list">
			<div class="item">
				<div class="row ">
					...
					<form:form method="POST" id="addForm" action="create-contacts"
						modelAttribute="contactBOs">
									...
									<div class="col-sm-12">
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<form:select type="text" path="assignedTo.name"
													class="form-control required">
													<form:option value="Select">-- Select --   </form:option>
										...
										<div class="col-sm-4">
											<div class="form-group">
												<label>Opportunity Source<span class="font10 text-danger">*</span></label>
