	...
	$(document).ready(function() {
		...
		$('#btnsubmit').click(function(e) {
			...
			if (slaname == 'select') {
				isValid = false;
				$("#slaNameErr").show();
				$("#slaNameErr").html("Please Select Workitem name");
				$("#slaId").css({
					"border" : "1px solid red",
		...
		<div class="item">
			<div class="row ">
				<div class="text-center underline">
					<h3>Edit Manage_WI_SLA</h3>
				</div>

				<form:form method="POST" id="addForm" action="edit-manage_WI_SLA"
					...
					<div class="col-sm-12">
							...
							<div class="form-group">
								...
								<form:select type="text" path="workItemBO.workItem"
									...
									<%-- <form:option value="${manageBO.workItemBO.workItemId}">${manageBO.workItemBO.workItem}</form:option> --%>
									 ...
									 <c:forEach items="${slaLists}" var="workItem">
                                                        <option <c:if test="${workItem.workItemId == manageBO.workItemBO.workItemId }">selected="selected"</c:if> value="${workItem.workItemId}">
                                                            ${workItem.workItem}</option>
                                                    </c:forEach> --%>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<form:select type="text" path="slaBO.slaName"
									id="slaId" class="form-control required">
									<%-- <form:option value="${manageBO.slaBO.slaId}">${manageBO.slaBO.slaName}</form:option>
									<form:option value="select">-- Select --</form:option> --%>
					...
					<div style="text-align: right; margin-right: 31px">
						<div class="form-group">
							...
							<a href="view-manage_WI_SLA?page=1"><span
