...
public abstract class PdfGenerator extends AbstractView {
	...
	public void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		generateInvoice(model, document, writer, request, response);
		document.close();
	...
	protected abstract void generateInvoice(Map<String, Object> model, Document document, PdfWriter writer,
